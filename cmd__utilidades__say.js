...
module.exports = {
    ...
    run: async (client, interaction) => {
        if (interaction.user.id !== dbp.get(`${interaction.user.id}`)) {
            interaction.reply({ flags: 64, content: `${emj.get(`13`)} | Você não tem permissão para usar este comando!`})
            return;
        }
                ...
                if (i.customId === "configbuttonadd") {
                    ...
                    i.awaitModalSubmit({ time: 600_000, filter: collectorFilter }).catch(() => {})
                        .then(i => {
                            ...
                            if (nmrbutton >= 5) {
                                i.reply({ content: `${emj.get(`13`)} **|** Não é possível adicionar mais um botão!`, flags: 64})
                                return;
                            }
                            ...
                            if (link.startsWith("https://")) {
                                ...
                                i.reply({ content: `${emj.get(`13`)} **|** Envie um link válido!`, flags: 64})
                                return;
                            }
                            ...
                            if (emoji) {
                                if (emojiRegex.test(emoji)) {
                                    ...
                                    i.reply({ content: `${emj.get(`13`)} **|** Envie um emoji válido!`, flags: 64})
                                    return;
                                }
                            }
                            buttons.push(
                    ...
                    if (buttons.length <= 0) {
                        i.reply({ content: `${emj.get(`13`)} **|** Não é possível remover mais um botão!`, flags: 64})
                        return;
                    }
                    ...
                    i.awaitModalSubmit({ time: 600_000, filter: collectorFilter }).catch(() => {})
                        .then(i => {
                            ...
                            if (isNaN(id)) {
                                i.reply({ content: `${emj.get(`13`)} **|** Coloque um número!`, flags: 64})
                                return;
                            }
                            if (id < buttons.length) {
                                i.reply({ content: `${emj.get(`13`)} **|** Escreva um número entre \`${buttons.length} - 1\`!`, flags: 64})
                                return;
                            }
                            if (id > buttons.length) {
                                i.reply({ content: `${emj.get(`13`)} **|** Escreva um número entre \`${buttons.length} - 1\`! 1aasd`, flags: 64})
                                return;
                            }
