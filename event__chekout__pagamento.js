...
const { bloquearBanco, bloquearBancoEfi, enviarProduto, deleteMessages, enviarProduto2, enviarProdutoEsales, bloquearBancoESales } = require("./fn__CarrinhoAprovado.js")
const { paymentMP, paymentEfiPay, paymentMPError, paymentEfiPaySales, paymentMPtimers } = require("./fn__GerenciarChekout.js")
module.exports = {
                    ...
                    msg.edit({ content: `${interaction.user}`, embeds: [embed], components: [row] }).then(msg => {
                        ...
                        collector.on('collect', interaction2 => {
                            ...
                            if (interaction2.customId == 'cpc') {
                                interaction2.reply({ content: `${data.pixCopiaECola}`, flags: 64 });
                            }
