...
const DbSaldo = new JsonDatabase({ databasePath: "./data__cupons.json" })
const dbrp = new JsonDatabase({ databasePath: "./data__rankProdutos.json"})
const dbinfopag = new JsonDatabase({ databasePath: "./data__infoPagamento.json" })
    ...
    run: async (interaction, client) => {
        ...
        if (interaction.isButton()) {
            ...
            if (customId.endsWith("_continuar")) {
                ...
                if (valor > produto.condições.valormaximo) {
                    return interaction.reply({ content: `${dbe.get(`13`)} | Valor máximo de **R$${Number(produto.condições.valormaximo).toLocaleString('pt-BR', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}** atingido! Escolha menos produtos.`, flags: 64})
                }
                if (valor < produto.condições.valorminimo) {
                    return interaction.reply({ content: `${dbe.get(`13`)} | Valor mínimo de **R$${Number(produto.condições.valorminimo).toLocaleString('pt-BR', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}** atingido! Escolha mais produtos.`, flags: 64})
                }
            ...
            if (customId.endsWith("_aprovarpedido")) {
                ...
                if (!rolevery) {
                    interaction.reply({ content: `${dbe.get(`13`)} | Você não tem permissão para mexer aqui!`, flags: 64})
                    return;
                }
                ...
                if (pdd.estoque.length <= 0) {
                    interaction.reply({ content: `${dbe.get(`13`)} | Peça para um staff reembolsa-lo! O estoque do produto que você deseja comprar acabou.`, flags: 64})
                    return;
                }
        ...
        if (interaction.isButton()) {
            ...
            if (customId.endsWith("_pedidos_mostrar")) {
                ...
                if (!pdInfo) return interaction.reply({ content: `${dbe.get("13")} | Pedido não encontrado!`, flags: 64 });
                ...
                await interaction.reply({ content: `${txt === false ? `${filed}` : `**Todos os produtos estão em um arquivo acima.**`}`, flags: 64 })
            }
        }
        if (interaction.isModalSubmit()) {
            ...
            if (customId.endsWith("_modal_reembolsarproduto")) {
                ...
                if (confir !== "sim") {
                    interaction.reply({ content: `${dbe.get(`13`)} | Você escreveu sim incorretamente!`, flags: 64})
                    return;
                }
                ...
                await refund.create({
                    ...
                    interaction.reply({ content: `${dbe.get(`6`)} | O valor total foi reembolsado!`, flags: 64})
                    ...
                    interaction.reply({ content: `${dbe.get(`13`)} | Ocorreu um erro ao tentar reembolsar o valor total!`, flags: 64})
                })
            }
            ...
            if (customId === "carrinho_addcupom") {
                ...
                if (CupomGlobal.nome === cupomUsado) {
                    ...
                    if (CupomGlobal.valormax && valor > CupomGlobal.valormax) {
                        interaction.reply({ content: `${dbe.get(`13`)} | Valor máximo atingido de **R$${Number(CupomGlobal.valormax).toLocaleString('pt-BR', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}**! Escolha menos produtos ou não use o cupom.`, flags: 64})
                        return;
                    }
                    if (CupomGlobal.valormin && valor < CupomGlobal.valormin) {
                        interaction.reply({ content: `${dbe.get(`13`)} | Valor mínimo atingido de **R$${Number(cupomEncontrado.valormin).toLocaleString('pt-BR', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}**! Escolha mais produtos ou não use o CupomGlobal.`, flags: 64})
                        return;
                    }
                    if (CupomGlobal.cargo) {
                        ...
                        if (!rolevery) {
                            interaction.reply({ content: `${dbe.get(`13`)} | Você não tem o cargo necessário para usar este cupom!`, flags: 64})
                            return;
                        }
                    }
                    ...
                    interaction.followUp({ content: `${dbe.get(`6`)} | Cupom adicionado!`, flags: 64 })
                    return;
                }
                ...
                if (cupomEncontrado) {
                    ...
                    if (cupomEncontrado.valormax && valor > cupomEncontrado.valormax) {
                        interaction.reply({ content: `${dbe.get(`13`)} | Valor máximo atingido de **R$${Number(cupomEncontrado.valormax).toLocaleString('pt-BR', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}**! Escolha menos produtos ou não use o cupom.`, flags: 64})
                        return;
                    }
                    if (cupomEncontrado.valormin && valor < cupomEncontrado.valormin) {
                        interaction.reply({ content: `${dbe.get(`13`)} | Valor mínimo atingido de **R$${Number(cupomEncontrado.valormin).toLocaleString('pt-BR', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}**! Escolha mais produtos ou não use o cupom.`, flags: 64})
                        return;
                    }
                ...
                interaction.reply({ content: `${dbe.get(`13`)} | Cupom não encontrado!`, flags: 64 })
            }
            ...
            if (customId === "carrinho_mudarqtd") {
                ...
                if (isNaN(qtd)) {
                    interaction.reply({ content: `${dbe.get(`13`)} | Quantidade inválida!`, flags: 64})
                    return;
                }
                ...
                if (pd.estoque.length < qtd) {
                    interaction.reply({ content: `${dbe.get(`13`)} | Quantidade inválida! A quantidade não pode ser maior que o estoque.`, flags: 64})
                    return;
                }
                if (qtd <= 0) {
                    interaction.reply({ content: `${dbe.get(`13`)} | Quantidade inválida! A quantidade não pode ser menor que o estoque.`, flags: 64})
                    return;
                }
                let valor = Number(pd.preco * qtd)
                if (dc.get(`${interaction.channel.id}.valormax`) && valor > dc.get(`${interaction.channel.id}.valormax`)) {
                    interaction.reply({ content: `${dbe.get(`13`)} | Valor máximo atingido de **R$${Number(dc.get(`${interaction.channel.id}.valormax`)).toLocaleString('pt-BR', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}**! Escolha menos produtos ou não use o cupom.`, flags: 64})
                    return;
                }
                if (dc.get(`${interaction.channel.id}.valormin`) && valor < dc.get(`${interaction.channel.id}.valormin`)) {
                    interaction.reply({ content: `${dbe.get(`13`)} | Valor mínimo atingido de **R$${Number(dc.get(`${interaction.channel.id}.valormin`)).toLocaleString('pt-BR', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}**! Escolha mais produtos ou não use o cupom.`, flags: 64})
                    return;
                }
                ...
                await interaction.update({ embeds: [embed], components: [row]})
                interaction.followUp({ content: `${dbe.get(`6`)} | Quantidade alterada!`, flags: 64})
                return;
            }
        }
    }
